    ...
    <footer className="w-full bg-black mt-48" id="footer">
      ...
      <div className="go-top-wrapper w-full relative">
        <a href="#header" className="go-top flex items-center justify-center flex-col bg-white w-16 h-16 rounded-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 shadow-black drop-shadow-lg duration-500 hover:scale-110" >
          <svg viewBox="0 0 24 24" className="fill-gold w-5 h-5">
            <path d="M23.245 20l-11.245-14.374-11.219 14.374-.781-.619 12-15.381 12 15.391-.755.609z"></path>
          </svg>
          <span className="uppercase text-gold">top</span>
        </a>
      </div>
      ...
      <section className="widgets container pt-14 mx-auto w-5/6 max-w-6xl flex flex-col items-start justify-start sm:flex-row sm:justify-between sm:gap-10">
        ...
        <Widget title="About Us" extraClassName="about us max-w-lg sm:order-first">
          ...
          Join us in celebrating Seyi&apos;s Birthday Celebration! We&apos;ve arranged complimentary airport transportation to make your journey as seamless as possible. Please book your transfer below and let us know your flight details so we can ensure a smooth arrival. We can&apos;t wait to celebrate with you!
          </p>
        </Widget>
      </section>

      <small className="text-white text-xsm text-center w-full block pt-10 pb-5">
         2026 - All Rights Reserved Seyi&apos;s Birthday Celebration &nbsp; | &nbsp; Powered by <a className="hover:text-gold" href="https://api.whatsapp.com/send?phone=5214493402622" target="_blank" rel="noreferrer">Dari Developer</a>
      </small>
    </footer>
  )
}